...
Route::get('/', function (Request $request) {
    ...
    return view('welcome', ["ads" => $ads, "slides" => $slides, "left_sliders" => $left_sliders, "right_sliders" => $right_sliders , "areas" => $areas,]);
})->name("home");
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/update-company', [ProfileController::class, 'update_company'])->name('update.company');
