                    ...
                    <div class="carousel-inner" style="height: 100%;">
                        ...
                        @foreach($banners as $i)
                            <div class="carousel-item {{$active ? "active" : null}}"
                                 style="height: 100%;background-image: url('{{asset("public/" . $i->path )}}');background-repeat: no-repeat;background-position: center;background-size: auto 100%">
                            </div>
                                <?php $active = false ?>
                        @endforeach
                    </div>
                        ...
                        <div class="feat mb-3 rounded">
                            <a href="{{route("company.profile",$com->company_name)}}">
                                <img class="mb-3  rounded-top"
                                     src="{{ $com->image && $com->image !== "#" ? asset( "public/" . $com->image) :asset("public/img/default.svg")}}"
                                     height="30" alt="">
                            </a>
