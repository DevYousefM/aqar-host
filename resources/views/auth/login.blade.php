        ...
        <div class="container">
            <div class="box">
                ...
                <form class="d-flex flex-column align-items-center gap-2" action="{{ route('login') }}" method="post">
                    @method('POST')
                    @csrf
                    <label class="mt-2" for="login_identifier">البريد الالكترونى او رقم الهاتف</label>
                    <input value="{{ old('login_identifier') }}" class="w-75 p-1 border" type="text"
                    ...
                    <div class="pass-con">
                        <input value="{{ old('password') }}" class="w-75 p-1 border " type="password" name="password">
