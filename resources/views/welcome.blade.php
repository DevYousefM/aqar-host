            ...
            @else
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{asset("public/slides/default.jpg")}}" class="d-block w-100" style="height: 60vh;"
