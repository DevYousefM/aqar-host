            ...
            <div class="offer d-flex flex-column flex-lg-row">
                    ...
                    <div class="container h-100vh p-3">
                        ...
                        @foreach($property->images as $img)
                            <div class="mySlides m-3 rounded">
                                <img class="rounded big-img" src="{{asset("public/property_images/".$img->path)}}"
                                     style="width: 100%;">
                            </div>
                        @endforeach
                        ...
                        <div class="row justify-content-center" style='gap:15px'>
                            ...
                            @foreach($property->images as $img)
                                <div class="column">
                                    <img class="demo cursor" src="{{asset("public/property_images/".$img->path)}}"
                                         style="width:100%"
                            ...
                            <div class="item">
                                <div class="card" style="width: 18rem;">
                                    <img
                                        ...
                                        width="100%"
                                        src="
                                    {{asset("public/property_images/".$e->images[0]->path)}}" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title"
                                            style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">{{$e->title}}</h5>
                                        <p class="card-text"
                                        ...
                                        <a href="{{route("property.show",['id'=>$e->id,'name'=>$e->title])}}" class="btn btn-danger">المزيد</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="description p-4 text-white">
                    <div class="address">
                        ...
                        @endif
                        @if($property->price)
                            <p class="currency border-bottom border-white pb-1 d-inline-block">{{number_format($property->price)}}
                                جنية </p>
                        @endif
                    </div>
