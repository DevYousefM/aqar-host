...
@section("content")
    <div class="card " id="arti">
        <div class="card-header">
            <h3 class="card-title col-12 mt-2">الباقات المنتهية</h3>
        </div>
        <!-- /.card-header -->
        ...
        @endphp
        <div class="card-body">
            <table class="table" id="expired_plans">
                <thead>
                <tr>
                ...
                <tbody>
                <?php $count = 1 ?>
                @foreach($expired_plans as $request)
                    <tr>
                        <td>{{$count}}</td>
                        <td>
        ...
        {{ $expired_plans->links('dashboard.paginate.paginate') }}
    </div>
@endsection
@section("script")
    <!-- DataTables -->
