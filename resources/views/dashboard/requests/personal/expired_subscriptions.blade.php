...
@section("content")
    <div class="card " id="arti">
        <div class="card-header">
            <h3 class="card-title col-12 mt-2">طلبات ترويج المستخدمين (المنتهية)</h3>
        </div>
        <!-- /.card-header -->
                ...
                @foreach($user_plans_requests as $request)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-row-reverse justify-content-end">
                                    <?php
                                    $expire_date = \Carbon\Carbon::parse($request->expire_date);
                                    ?>
                                <span>
                        ...
                        <td>
                            <div class="d-flex flex-row-reverse justify-content-end">
                                <span>
                                    {{$request->updated_at->format('d')}}
                                </span>
                                <span class="mx-1">
                                    {{$request->updated_at->format('M')}}
                                </span>
                                <span>
                                    {{$request->updated_at->format('Y')}}
                                </span>
                            </div>
                        </td>
                        <td>
