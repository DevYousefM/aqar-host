    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form role="form" action="{{route("update.article",$article->id)}}"
                      method="post"
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body" rows="3"
                                      placeholder="نص المقال هنا">{{ $article->body }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="brief" rows="3"
                                      placeholder="نبذة المقال هنا">{{ $article->brief }}</textarea>
                        </div>
                    </div>
