            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('all.articles') }}">اخبار العقارات</a></li>
        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title float-none mb-0">تعديل مقال </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form role="form" action="{{ route('update.article', $article->id) }}" method="post"
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputFName" placeholder=""
                                name="title_seo" value="{{ $article->title_seo }}">
                            @error('title_seo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputFName" placeholder="" name="url_name"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body" rows="3" placeholder="نص المقال هنا">{{ $article->body }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputFName" placeholder=""
                                name="image_alt" value="{{ $article->image_alt }}">
                            @error('image_alt')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="brief" rows="3" placeholder="نبذة المقال هنا">{{ $article->brief }}</textarea>
                        </div>
                    </div>
