            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('admin.store') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input style="border: 1px solid gray;" type="login_identifier" name="login_identifier" value="{{ old('login_identifier') }}"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input style="border: 1px solid gray;" type="password" name="password"
                            class="form-control text-right" placeholder="كلمة المرور">
                    </div>
                    @error('password')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
