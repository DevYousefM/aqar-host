...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>اضافة اعلان الي الاسلايدر</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="#">الاعلانات</a></li>
                        <li class="breadcrumb-item active">أضافة اعلان الي الاسلايدر</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title float-none mb-0">اضافة اعلان جديد الي الاسلايدر</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form role="form" action="{{route("store.slider")}}"
                      method="post"
