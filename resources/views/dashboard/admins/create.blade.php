                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="#">المسئولين</a></li>
                        <li class="breadcrumb-item active">أضافة مسئول</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title float-none mb-0">اضافة مسئول جديد</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form role="form" action="{{route("admin.reg.store")}}"
                      method="post">
                    @method("post")
                    @csrf
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">أضافة <i class="fa fa-plus"></i>
                        </button>
                    </div>
                </form>
            </div>
