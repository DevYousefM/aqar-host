...
return [
    ...
    */
    ...
    | administration panel to add roles and permissions to the admins.
    |
    ...
    */
    'foreign_keys' => [
        /**
         * User foreign key on Laratrust's role_admin and permission_admin tables.
         */
        'admin' => 'admin_id',
    ...
    */
    ...
    'teams' => [
        ...
        */
        ...
        | it will check only if the admin has added that role/permission ignoring the team.
        |
        */
        'strict_check' => false,
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Determines if you can check if a admin has a permission using the "can" method.
    |
    */
