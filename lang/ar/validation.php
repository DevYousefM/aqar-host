...
return [
    ...
    'attributes' => [
        ...
        'phone' => 'الهاتف',
        'phone_second' => 'رقم الهاتف الثانوي',
        'photo' => 'الصورة',
        ...
        "value" => "القيمة",
        "reason" => "سبب الصرف",
        "days_num" => "عدد ايام ظهور الاعلان كإعلان مميز",
        "social_media_appear" => "الظهور علي السوشيال ميديا في المنطقة المستهدفة",
        "property_num" => "عدد المشاريع",
        "special_property_num" => "عدد الاعلانات المميزة",
        "facebook_ads_num" => "عدد الاعلانات المدفوعة علي فيسبوك",
        "header_appear_days" => "عدد ايام الظهور في الهيدر",
        "slider_appear_days" => "عدد ايام الظهور في السلايدر",
